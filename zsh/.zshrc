...
# Use Vim keybindings everywhere and exit insert mode with "jk"
export KEYTIMEOUT=5
...
# ↑ / ↓ to search backward/forward through history matching current input
bindkey '^[[A' history-search-backward
bindkey '^[[B' history-search-forward

# Additional keys (common alternatives)
bindkey '^P' history-search-backward     # Ctrl+P
bindkey '^N' history-search-forward      # Ctrl+N
#bindkey '\e[A' history-search-backward   # for some terminals
